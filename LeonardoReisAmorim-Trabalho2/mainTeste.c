...
// void testeListaEncadeada(); nao considerar lista encadeada
...
int main()
{
  ...
  // testeListaEncadeada(); nao considerar lista encadeada
  finalizar();
}
int ligado = 1;
void show_log(char *str)
...
void testeExcluirNumeroEspecifico()
{
  ...
  printf("%d\n", excluirNumeroEspecificoDeEstrutura(9, 4) == SUCESSO); // adicionado, pois a ausência da mesma estava gerando erros em testes posteriores.
...
// Desconsiderar lista encadeada
/*void testeListaEncadeada()
{
    show_log("testeListaEncadeada()");

    int vet[10], tamVet = 10;
