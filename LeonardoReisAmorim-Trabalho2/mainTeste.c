...
void testeListar()
{
    ...
    printf("%d\n", getDadosEstruturaAuxiliar(1, vet, vetTam) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d\n", getDadosEstruturaAuxiliar(11, vet, vetTam) == POSICAO_INVALIDA);
    printf("%d\n", getDadosEstruturaAuxiliar(2, vet, vetTam) == SUCESSO);

    printf("%d\n", vet[0] == 7);
    printf("%d\n", vet[1] == -9);

    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(1, vet, vetTam) == SEM_ESTRUTURA_AUXILIAR);
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(11, vet, vetTam) == POSICAO_INVALIDA);
    printf("%d\n", getDadosOrdenadosEstruturaAuxiliar(2, vet, vetTam) == SUCESSO);
...
void testeRetornarTodosNumeros()
{
    ...
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet1, vetTam) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS);

    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet1, vetTam) == TODAS_ESTRUTURAS_AUXILIARES_VAZIAS);
...
*/
    ...
    printf("%d\n", getDadosDeTodasEstruturasAuxiliares(vet, vetTam) == SUCESSO);
    ...
    printf("%d\n", getDadosOrdenadosDeTodasEstruturasAuxiliares(vet2, vetTam) == SUCESSO);
...
void testeListaEncadeada()
{
    ...
    int vet[10], vetTam = 10;

    No *inicio = montarListaEncadeadaComCabecote();
    
    getDadosListaEncadeadaComCabecote(inicio, vet, vetTam);
